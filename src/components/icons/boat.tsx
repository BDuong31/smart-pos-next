...
export default function BoatRegular() {
    ...
    return (
        ...
        >
            ...
            <path fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="M320 96V72a24.07 24.07 0 0 0-24-24h-80a24.07 24.07 0 0 0-24 24v24m224 137v-89a48.14 48.14 0 0 0-48-48H144a48.14 48.14 0 0 0-48 48v92m160-52.4v212.85"></path>
        </svg>
    )
}

export function BoatBold() {
    const { theme } = useTheme();
    return (
        <svg
            className="dark:stroke-[#F8F8F8] stroke-[#1F1F1F]"
