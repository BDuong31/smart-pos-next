...
export default function ChatbubbleEllipsesRegular() {
...
export function ChatbubbleEllipsesBold() {
    const { theme } = useTheme();
    return (
        <svg
            className="dark:stroke-[#F8F8F8] stroke-[#1F1F1F]"
