...
export default function FileTrayEmptyRegular() {
    ...
    return (
        ...
        >
	        ...
	        <path fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="M48 272h144m128 0h144m-272 0a64 64 0 0 0 128 0"></path>
        </svg>
    )
}

export function FileTrayEmptyBold() {
    const { theme } = useTheme();
    return (
        <svg
            className="dark:stroke-[#F8F8F8] stroke-[#1F1F1F]"
