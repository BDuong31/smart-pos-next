...
export default function CheckboxRegular() {
    ...
    return (
        ...
        >
	        ...
	        <rect width={384} height={384} x={64} y={64} fill="none" strokeLinejoin="round" strokeWidth={32} rx={48} ry={48}></rect>
        </svg>
    )
}

export function CheckboxBold() {
    const { theme } = useTheme();
    return (
        <svg
            className="dark:stroke-[#F8F8F8] stroke-[#1F1F1F]"
