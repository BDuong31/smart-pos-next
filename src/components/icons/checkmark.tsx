...
export default function CheckmarkRegular() {
    ...
    return (
        ...
        >
	        ...
	        <path fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="M352 176L217.6 336L160 272"></path>
        </svg>
    )
}

export function CheckmarkBold() {
    const { theme } = useTheme();
    return (
        <svg
            className="dark:stroke-[#F8F8F8] stroke-[#1F1F1F]"
